...
You've been teaching me how the planner handles CTEs, in five steps:
...
We're done: for step 5 you asked me what that means for a CTE wrapping an
expensive aggregate that two later branches both read. I said the aggregate
could run twice, so I'd materialise it or push it into a temp table if the
plan shows the double scan.
